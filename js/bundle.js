/******/ (() => {
  ...
  \*************************************/
      /***/ (
        ...
        /* harmony import */ var _myModule__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./myModule */ "./js/modules/myModule.js");

        var IdDataHandler = {
          existingUseID: function existingUseID(currentButton) {
            var useID = inputElement.value;
            var sec = Number(pintSec.value) * 1000;
            _myModule__WEBPACK_IMPORTED_MODULE_0__["default"].words(
              useID,
              sec,
              currentButton
            );
  ...
  \*******************************************/
      /***/ (
        ...
        /* harmony import */ var _IdDataHandler_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./IdDataHandler.js */ "./js/modules/IdDataHandler.js"
          );
            ...
            if (target && target.classList.contains(PLAY)) {
              switch (target.className) {
                case PLAY:
                  ...
                  _IdDataHandler_js__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
      ...
      /***/ (
        ...
        var voicePlay = {
          getUtterance: function getUtterance(text) {
            var rate = document.getElementById("speed");
  ...
  \********************************/
      /***/ (
        ...
        /* harmony import */ var _processLines__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./processLines */ "./js/modules/processLines.js"
          );
        /* harmony import */ var _countdownTimer__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./countdownTimer */ "./js/modules/countdownTimer.js"
          );
        function _typeof(o) {
                                      ...
                                      while (1)
                                        switch (
                                          ...
                                          case 0:
                                            ...
                                            searchString = '"id": "'.concat(
                                              currentID,
                                              '"'
                                            );
                                            startIndex =
                                              result.indexOf(searchString);
                                            if (!(startIndex !== -1)) {
                                              _context.next = 22;
                                              break;
                                            }
                                          ...
                                          case 12:
                                            ...
                                            (0,
                                            _countdownTimer__WEBPACK_IMPORTED_MODULE_1__[
                                              "default"
                                            ])(initialSeconds, initialSeconds);
                                            (0,
                                            _processLines__WEBPACK_IMPORTED_MODULE_0__[
                                              "default"
                                            ])(dataChunk);
                                          ...
                                          case 19:
                                            console.log(
                                              "Начало или конец строки не найдены."
                                            );
                                          case 20:
                                            _context.next = 23;
                                            break;
  ...
  \************************************/
      /***/ (
        ...
        /* harmony import */ var _getUtterance__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./getUtterance */ "./js/modules/getUtterance.js"
          );
        /* harmony import */ var _buttonsClickHandler__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./buttonsClickHandler */ "./js/modules/buttonsClickHandler.js"
          );
        function _typeof(o) {
          "@babel/helpers - typeof";
          return (
        ...
        function _processLines() {
          _processLines = _asyncToGenerator(
                  ...
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      (id = parsedData.id),
                        ...
                        (title = parsedData.title); // console.log("processLines:", id, name, title);
                      if (
                        _buttonsClickHandler__WEBPACK_IMPORTED_MODULE_1__.currentButton ===
                        "but1"
                      ) {
                        text = "".concat(name);
                      ...
                      Utl =
                        _getUtterance__WEBPACK_IMPORTED_MODULE_0__[
                          "default"
                        ].getUtterance(text);
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _modules_buttonsClickHandler__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! ./modules/buttonsClickHandler */ "./js/modules/buttonsClickHandler.js"
      );
    /* harmony import */ var _modules_getUtterance__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./modules/getUtterance */ "./js/modules/getUtterance.js"
      );
    /* harmony import */ var _modules_controlCheckBox__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ./modules/controlCheckBox */ "./js/modules/controlCheckBox.js"
      );
    ...
    but1.addEventListener("click", function (event) {
      _modules_buttonsClickHandler__WEBPACK_IMPORTED_MODULE_0__[
        "default"
      ].handleClick(event);
    });
    ...
    (0, _modules_controlCheckBox__WEBPACK_IMPORTED_MODULE_2__["default"])();
  })();
