...
var myModule = {
  words: function () {
    var _words = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(useID, sec) {
      var filePath, response, data, foundIndex, remainingData, previousObject, _iterator, _step, dataWord;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            foundIndex = data.dictionary.findIndex(function (dataWord) {
              return dataWord.id === useID;
            });
            if (!(foundIndex !== -1)) {
              _context.next = 37;
              break;
            ...
            remainingData = data.dictionary.slice(foundIndex); // Очищаем предыдущий объект
            previousObject = null; // Читаем объекты из потока и выводим их в консоль с задержкой
            _iterator = _createForOfIteratorHelper(remainingData);
            _context.prev = 15;
            _iterator.s();
          case 17:
...
function _processLines() {
  _processLines = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dataWord) {
    var id, name, title, text, Utl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          id = dataWord.id, name = dataWord.name, title = dataWord.title;
