...
var voicePlay = {
  getUtterance: function getUtterance(text, language, currentButton1) {
    ...
    if (language && currentButton1 === "but1") {
      var languageMap = {
        En: ["Google US English (en-US)", "английский Соединенные Штаты (en-US)", "en-US"],
    ...
    if (!selectedVoice) {
      ...
      console.log("\uD83D\uDD01 Fallback: \u0432\u044B\u0431\u0440\u0430\u043D \u0433\u043E\u043B\u043E\u0441 \u0438\u0437 UI \u2014 ".concat(_selectedVoiceName || "не найден"));
    }
    if (!selectedVoice) {
      selectedVoice = availableVoices[0];
      console.warn("\u26A0\uFE0F \u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u0442\u0441\u044F \u043F\u0435\u0440\u0432\u044B\u0439 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0439 \u0433\u043E\u043B\u043E\u0441: ".concat(selectedVoice.name));
    }
...
var myModule = {
  ...
  words: function () {
    var _words = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var requestAdd, filePaths, sec, foundObjects, _iterator, _step, filePath, response, text, jsonData, dataArray, filtered, groupedById, _iterator2, _step2, _group$, group, groupId, startId, endId, _iterator3, _step3, entry, initialSeconds;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 55:
            ...
            }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.toArray)() // ← вот это собирает все группы в массив
            ));
          case 57:
          ...
          case 64:
            ...
            groupId = Number((_group$ = group[0]) === null || _group$ === void 0 ? void 0 : _group$.id);
            startId = Number(currentID);
            endId = startId + Number(count_n_Word) - 1; // Если ID группы выходит за выбранный диапазон — выходим из цикла
            if (!(groupId > endId)) {
              _context.next = 72;
              break;
            }
          ...
          case 82:
            ...
            (0,_processLines_js__WEBPACK_IMPORTED_MODULE_0__["default"])(JSON.stringify(entry));
      ...
      }, _callee, null, [[9, 112], [11, 46, 49, 52], [62, 102, 105, 108], [73, 92, 95, 98]]);
    }));
    function words() {
...
/* harmony import */ var fitty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! fitty */ "./node_modules/fitty/dist/fitty.module.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; var r = _regenerator(), e = r.m(_regeneratorRuntime), t = (Object.getPrototypeOf ? Object.getPrototypeOf(e) : e.__proto__).constructor; function n(r) { var e = "function" == typeof r && r.constructor; return !!e && (e === t || "GeneratorFunction" === (e.displayName || e.name)); } var o = { "throw": 1, "return": 2, "break": 3, "continue": 3 }; function a(r) { var e, t; return function (n) { e || (e = { stop: function stop() { return t(n.a, 2); }, "catch": function _catch() { return n.v; }, abrupt: function abrupt(r, e) { return t(n.a, o[r], e); }, delegateYield: function delegateYield(r, o, a) { return e.resultName = o, t(n.d, _regeneratorValues(r), a); }, finish: function finish(r) { return t(n.f, r); } }, t = function t(r, _t, o) { n.p = e.prev, n.n = e.next; try { return r(_t, o); } finally { e.next = n.n; } }), e.resultName && (e[e.resultName] = n.v, e.resultName = void 0), e.sent = n.v, e.next = n.n; try { return r.call(this, e); } finally { n.p = e.prev, n.n = e.next; } }; } return (_regeneratorRuntime = function _regeneratorRuntime() { return { wrap: function wrap(e, t, n, o) { return r.w(a(e), t, n, o && o.reverse()); }, isGeneratorFunction: n, mark: r.m, awrap: function awrap(r, e) { return new _OverloadYield(r, e); }, AsyncIterator: _regeneratorAsyncIterator, async: function async(r, e, t, o, u) { return (n(e) ? _regeneratorAsyncGen : _regeneratorAsync)(a(r), e, t, o, u); }, keys: _regeneratorKeys, values: _regeneratorValues }; })(); }
function _regeneratorValues(e) { if (null != e) { var t = e["function" == typeof Symbol && Symbol.iterator || "@@iterator"], r = 0; if (t) return t.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) return { next: function next() { return e && r >= e.length && (e = void 0), { value: e && e[r++], done: !e }; } }; } throw new TypeError(_typeof(e) + " is not iterable"); }
function _regeneratorKeys(e) { var n = Object(e), r = []; for (var t in n) r.unshift(t); return function e() { for (; r.length;) if ((t = r.pop()) in n) return e.value = t, e.done = !1, e; return e.done = !0, e; }; }
...
function _processLines() {
  _processLines = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dataChunk) {
    var currentButton1, parsedData, id, name, title, subscrb, language, isOverflowing, utterance;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          document.querySelectorAll("textarea").forEach(function (el) {
            if (isOverflowing(el)) {
              ...
              (0,fitty__WEBPACK_IMPORTED_MODULE_3__["default"])(el, {
                minSize: 20,
                maxSize: 30
              });
            } else {
          ...
          console.log("Вызов voicePlay.getUtterance для текста:", text, language, name, title, currentButton1);

          // Вызов voicePlay.getUtterance для воспроизведения текста
          utterance = _getUtterance_js__WEBPACK_IMPORTED_MODULE_2__["default"].getUtterance(text, language, currentButton1);
